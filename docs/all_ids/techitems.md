<table>
    <thead>
        ...
        <tr>
            <td>Automation Overlay</td>
            <td>AutomationOverlay</td>
            <td></td>
        </tr>
        <tr>
            <td>Exosuit Overlay</td>
            <td>SuitsOverlay</td>
            <td></td>
        </tr>
        <tr>
            <td>Advanced Research Capability</td>
            <td>BetaResearchPoint</td>
            <td></td>
        </tr>
        <tr>
            <td>Data Analysis Research Capability</td>
            <td>OrbitalResearchPoint</td>
            <td>Spaced Out</td>
        </tr>
        <tr>
            <td>Conveyor Overlay</td>
            <td>ConveyorOverlay</td>
            <td></td>
        </tr>
        <tr>
            <td>Jet Suit Pattern</td>
            <td>JetSuit</td>
            <td></td>
        </tr>
        <tr>
            <td>Atmo Suit Pattern</td>
            <td>AtmoSuit</td>
            <td></td>
        </tr>
        <tr>
            <td>Oxygen Mask Pattern</td>
            <td>OxygenMask</td>
            <td></td>
        </tr>
        <tr>
            <td>Materials Science Research Capability</td>
            <td>DeltaResearchPoint</td>
            <td>Spaced Out</td>
        </tr>
        <tr>
            <td>Lead Suit Pattern</td>
            <td>LeadSuit</td>
            <td>Spaced Out</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Large Solid Oxidizer Tank</td>
